...
class PseudoLocationManager(private val context: Context,
    ...
    private val latitudes = doubleArrayOf(pluralsightFarmingtonWestLat, pluralsightFarmingtonEastLat, pluralsightSouthJordanLat)
    private val longitudes = doubleArrayOf(pluralsightFarmingtonWestLon, pluralsightFarmingtonEastLon, pluralsightSouthJordanLon)
