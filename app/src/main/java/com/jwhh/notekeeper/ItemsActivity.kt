...
class ItemsActivity : AppCompatActivity(),
    ...
    lateinit var viewModel: ItemActivityViewModel
    ...
    private val recentlyViewedNoteRecyclerAdapter by lazy {
        val adapter = NoteRecyclerAdapter(this, viewModel.recentlyViewedNotes /*recentlyViewedNotes*/)
        adapter.setOnSelectedListener(this)
        adapter
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this,ItemActivityViewModelFactory(application)).get(ItemActivityViewModel::class.java)
        //displayNotes()
